...
export default function PageMenu({ menuImages }: { menuImages: ImageType[] }) {
  ...
  return (
    <div ref={containerRef} className="relative w-full h-dvh overflow-y-auto overflow-x-hidden [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
